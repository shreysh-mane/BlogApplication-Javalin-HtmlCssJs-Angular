...
//     //   date: this.updateBlogForm.value.date,
//     //   featuredImage: this.updateBlogForm.value.featuredImage
//     // };

//     this.blogService.updateBlog(this.blogId, this.updateBlogForm).subscribe(
//       () => {
